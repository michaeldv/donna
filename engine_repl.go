...
func (e *Engine) Repl() *Engine {
	...
	benchmark := func() {
		...
		game = NewGame(`Kg1,Rb7,Na4,a2,b2,f4,g2,g3`, `M30,Kh7,Rd2,Bb6,a7,c5,c4,g7,h6`)
		position = game.start()
		fmt.Printf("%s\n", position)
		game.Think()
		...
		game = NewGame(`Kh1,Qe2,Ra1,Rf1,Bb2,Be4,Nc3,a3,b4,e5,f4,g2,h2`, `M21,Kg8,Qe7,Rc8,Rd8,Bb6,Bb7,Ng4,a6,b5,e6,f7,g7,h7`)
		position = game.start()
		fmt.Printf("%s\n", position)
		game.Think()
		...
		game = NewGame(`Ke1,Qa3,Rd1,Rh1,Bc4,Bc5,Nf3,a2,d4,f2,g2,h2`, `M16,Kg8,Qb6,Ra8,Rf8,Bg4,Bg7,Nc3,a7,b7,c6,f7,g6,h7`)
		position = game.start()
		fmt.Printf("%s\n", position)
		game.Think()
		...
		game = NewGame(`M17,Kg1,Qc2,Ra1,Re1,Bc1,Bg2,Ng5,a2,b2,c3,d4,f2,g3,h2`, `Kg8,Qd6,Ra8,Rf8,Bc8,Nd5,Ng6,a7,b6,c4,e6,f7,g7,h7`)
		position = game.start()
		fmt.Printf("%s\n", position)
		game.Think()
		...
		game = NewGame(`M30,Kg1,Qe5,Bb2,Ng3,c3,d4,e6,g2,h2`, `Kg7,Qe7,Nb3,Nf6,a7,b6,c4,d5,g6,h7`)
		position = game.start()
		fmt.Printf("%s\n", position)
		game.Think()
	}
