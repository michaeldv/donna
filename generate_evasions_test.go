...
func TestGenEvasions300(t *testing.T) {
	p := NewGame(`Ka5,Ra8`, `M,Kg8,Qf6,Re6,Bc6,Bg7,Na6,Nb6,f7,g6,h5`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions310(t *testing.T) {
	p := NewGame(`Ka1,Ra8,Nf6`, `M,Kg8,Qc6,Bb7,Nb6,f7,g6,h7`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions320(t *testing.T) {
	p := NewGame(`Ka1,Ra8,Be5`, `M,Kh8,Qd5,Bb7,Nb6`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions330(t *testing.T) {
	p := NewGame(`Kh6,Be5`, `M,Kh8,d6`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions340(t *testing.T) {
	p := NewGame(`Ke1,e2,f2,g2`, `Kc3,Nf3`).start()
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions350(t *testing.T) {
	p := NewGame(`Kf8,Ba1`, `M,Kh8,b3,c4,d5,e6,f7`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions360(t *testing.T) {
	p := NewGame(`Ka5,a4,b4,c4,d4,e4,f4,h4`, `Kh8,Qh5`).start()
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions365(t *testing.T) {
	p := NewGame(`Ke1,Rh4`, `M,Kh6,h7`).start()
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions370(t *testing.T) {
	p := NewGame(`Kd4,d5,f5`, `M,Kd8,e7`).start()
...
func TestGenEvasions380(t *testing.T) {
	p := NewGame(`Kb1,b2`, `Ka5,a4,c5,c4`).start()
	p = p.makeMove(NewMove(p, B2, B4))
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions385(t *testing.T) {
	p := NewGame(`Ke4,c5,e5`, `M,Ke7,d7`).start()
...
func TestGenEvasions386(t *testing.T) {
	p := NewGame(`Kf1,Qa2`, `M,Kf7,b2`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions390(t *testing.T) {
	p := NewGame(`Kh4,a2,b2,c2,d2,e2,f2,g2`, `Kd8,Ra4`).start()
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions400(t *testing.T) {
	p := NewGame(`Kd8,Rh5`, `M,Ka5,b7,c7,d7,e7,f7,g7,h7`).start()
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions410(t *testing.T) {
	p := NewGame(`Ke1,Qd1,Rc7,Bd3,Nd4,c2,f2`, `M,Kh8,Nb4`).start()
	p = p.makeMove(NewMove(p, B4, C2))
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions420(t *testing.T) {
	p := NewGame(`Ke1,Qd1,Rd7,Bf1,Nc1,c2,d3,f2`, `M,Kh8,Nb4`).start()
	p = p.makeMove(NewMove(p, B4, D3))
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions430(t *testing.T) {
	p := NewGame(`Ke1,Qf7,f2`, `M,Kh8,Qh4`).start()
	p = p.makeMove(NewMove(p, H4, F2))
	white := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions440(t *testing.T) {
	p := NewGame(`Kf1,Qf3,Nf2`, `Ka1,b2`).start()
	p = p.makeMove(NewMove(p, F3, D1))
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions450(t *testing.T) {
	p := NewGame(`Kf1,Qf3,Nf2`, `Ka1,b2,c2`).start()
	p = p.makeMove(NewMove(p, F3, D1))
	black := NewMoveGen(p).generateEvasions(p)
...
func TestGenEvasions460(t *testing.T) {
	p := NewGame(`Kf1,Qf3,Nf2`, `Kc1,c2,d2`).start()
	p = p.makeMove(NewMove(p, F3, D1))
	black := NewMoveGen(p).generateEvasions(p)
