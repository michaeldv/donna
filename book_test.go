...
func TestBook010(t *testing.T) { // 1. e4
        ...
        position.color ^= 1
        book := NewBook("")
        expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x823C9B50FD114196`)
}
...
func TestBook020(t *testing.T) { // 1. e4 d5
        ...
        position := game.Start()
        book := NewBook("")
        expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x0756B94461C50FB0`)
}
...
func TestBook030(t *testing.T) { // 1. e4 d5 2. e5
        ...
        position.color ^= 1
        book := NewBook("")
        expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x662FAFB965DB29D4`)
}
...
//         position := game.Start()
//         book := NewBook("")
//         expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x22A48B5A8E47FF78`)
// }
// 
...
//         position.color ^= 1
//         book := NewBook("")
//         expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x652A607CA3F242C1`)
// }
// 
...
//         position.color ^= 1
//         book := NewBook("")
//         expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x00FDD303C946BDD9`)
// }
// 
...
//         position.color ^= 1
//         book := NewBook("")
//         expect(t, fmt.Sprintf(`0x%016X`, book.polyglot(position)), `0x5C3F9B829B279560`)
// }
